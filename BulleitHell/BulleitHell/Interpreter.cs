                ...
                if(this.level.waves.ElementAt(0).TimeDelta == 0)
                {
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < curWave.EnemyCount; i++)
                        {
                            ...
                            pos = new Vector2(curWave.XPos, curWave.YPos);

                            GameManager.QueueEnemy((GameManager.CreateEnemey(pos, (Property.EnemyType)curWave.EnemyType, curWave.MovementStrategy, curWave.BulletStrategy)));
                        }
